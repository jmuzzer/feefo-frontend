...
describe('RatingSummary', () => {
  ...
  test.each(testRatings)(
    ...
    ({ averageRating, category }) => {
      ...
      expect(
        screen.getByRole('paragraph', { name: 'Category rating' }),
      ...
      expect(averageRatingElement).toHaveTextContent(
  ...
  test('renders all summary elements', () => {
    ...
    expect(
      screen.getByRole('paragraph', { name: 'Average rating' }),
    ).toHaveTextContent('4.2 OUT OF 5');
  });
});
